import { AccessCheckResult } from '../enums';

export class CrashResult {
  id: number;
  crashDate: Date;
  crashTime: Date;
  hsmvReportNumberDisp: string;
  agencyReportNumberDisp: string;
  mapPointX?: number;
  mapPointY?: number;
  symbolAngle?: number;
  crashSegId?: number;
  ...
  reportImageExists: boolean;

  userCanEditReport: boolean;
  userCanViewReportNumber: boolean;

  userCanViewReportImage: AccessCheckResult;
